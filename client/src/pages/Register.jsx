    ...
    <div className="bg-slate-50 min-h-screen py-16 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-xs mt-1.5 font-medium">Create your account and start shopping! 🛍️</p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-slate-900 hover:bg-orange-500 text-white font-bold py-3.5 rounded-xl transition duration-300 text-sm shadow-md mt-6 tracking-wide"
          >
            Register
          </button>
        </form>
